INSERT IGNORE INTO `zonas` (`id`, `ciudadid`, `latitud`, `longitud`, `nombre`, `voluntarioszona`) VALUES
...
INSERT IGNORE INTO `zonas_entity_batidaid` (`zonas_entity_id`, `batidaid`) VALUES
(5, 1),
(5, 2);